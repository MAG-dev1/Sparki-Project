...
public class TaskController {
    ...
    @GetMapping("/{username}")
    public ResponseEntity<?> getTasksById(@PathVariable String username, @RequestHeader("Authorization") String token) throws Exception{
        List<TaskGetDTO> tasks = taskService.getAllTasksByusername(username, token);
